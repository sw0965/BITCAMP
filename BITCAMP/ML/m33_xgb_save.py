...
# import joblib
# joblib.dump(model, "./MODEL/sample/xgb_save/cancer.joblib.dat.dat")
model.save_model("./MODEL/sample/xgb_save/cancer.xgb.model")
print('저장')

model2 = XGBClassifier()
model.load_model("./MODEL/sample/xgb_save/cancer.xgb.model")
print('로드')
