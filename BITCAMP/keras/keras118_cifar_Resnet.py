...
resnet = ResNet101V2(include_top=False, weights='imagenet', input_tensor=input_tensor)

top_model = resnet.output
top_model = Flatten(input_shape=resnet.output_shape[1:])(top_model)
top_model = Dense(256, activation = 'sigmoid')(top_model)
top_model = Dropout(0.2)(top_model)
top_model = Dense(10, activation='softmax')(top_model)

model = Model(inputs=resnet.input, outputs=top_model)
...
# dropout = 0.2
# test loss : 3.1395629734039305
# test acc : 0.11680000275373459
