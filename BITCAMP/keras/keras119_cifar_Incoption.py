...
inception = InceptionResNetV2(include_top=False, weights='imagenet', input_tensor=input_tensor)

top_model = inception.output
top_model = Flatten(input_shape=inception.output_shape[1:])(top_model)
...
# dropout = 0.5
# test loss : 1.4383036323547362
# test acc : 0.5023999810218811

# dropout = 0.2
# test loss : 1.4142304752349855
# test acc : 0.5098000168800354