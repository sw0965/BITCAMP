...
modelpath     = './model/sample/cancer/{epoch:02d}-{val_acc:.4f}.hdf5'
cp            = ModelCheckpoint(filepath=modelpath, monitor='val_acc', save_best_only=True, mode='auto')
model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['acc'])
hist          = model.fit(x_train, y_train, validation_split=0.5, epochs=9, batch_size=64, verbose=1, callbacks=[es,cp,tb])
...
'''
loss :  0.6885385286738301
acc :  0.6052631735801697


loss :  0.31397397564611756
acc :  0.9093567132949829
'''