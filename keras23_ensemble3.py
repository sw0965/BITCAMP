...
middle1_2 = Dense(20, name='mid2')(middle1)
middle1_3 = Dense(30, name='mid3')(middle1_2)
middle1_4 = Dense(10, name='mid4')(middle1_3)


###### output 모델 구성 ######
#첫번째 아웃풋
output1 = Dense(80, name='ot1_1')(middle1_4) #middle 위에 합쳤던거 마지막 이름을 가져다 인풋으로 쓴다.
output1_2 = Dense(70, name='ot1_2')(output1)
output1_3 = Dense(60, name='ot1_3')(output1_2)
output1_4 = Dense(50, name='ot1_4')(output1_3)
output1_5 = Dense(3, name='ot1_5')(output1_4)
...
model = Model(inputs = [input1,input2], 
              output = output1_5) #히든레이어 명시가 필요없으니 위에 명시를 해주는것 Sequential() 이거처럼
