...
lstm1    = LSTM (2,    activation='relu')(input1)
dens1    = Dense(1024, activation='relu')(lstm1)

output1  = Dense(1024, activation='relu')(dens1)
dens2    = Dense(1024, activation='relu')(output1)
dens3    = Dense(100,  activation='relu')(dens2)

model    = Model(inputs=input1, outputs=dens3)
