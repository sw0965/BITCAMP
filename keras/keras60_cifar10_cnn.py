...
conv3 = Conv2D(64, (2,2), activation='relu')(conv2)
drop = Dropout(0.2)(conv3)
maxp1 = MaxPooling2D(pool_size=2)(drop)

flat = Flatten()(maxp1) 
den1 = Dense(30, activation='relu')(flat)
...
model.fit(x_train,y_train,epochs=1000,batch_size=512,verbose=1 ,validation_split=0.8 ,callbacks=[early_stopping, checkpoint])
...
loss :  2.7390524696350096
acc :  0.6294999718666077
'''
