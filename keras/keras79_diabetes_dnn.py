...
#데이터 전처리 2. 정규화
x_train = x_train.reshape(309, 10).astype('float32')/255
x_test = x_test.reshape(133, 10).astype('float32')/255
...
es            = EarlyStopping(monitor='acc', patience=3, mode='auto')
modelpath     = './model/sample/diabets/{epoch:02d}-{val_acc:.4f}.hdf5'
