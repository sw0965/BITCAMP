...
df1 = pd.read_csv('./data/csv/kospi200.csv', index_col=0, header=0, encoding='cp949', sep=',')

print('df1 : ',df1)
print(df1.shape)

df2 = pd.read_csv('./data/csv/samsung.csv', index_col=0, header=0, encoding='cp949', sep=',')
