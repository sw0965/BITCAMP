...
# 훈련
modelpath = './mini_project/pro_cp_data/1_cnn_model-{epoch:02d}-{val_loss:.4f}.hdf5'
...
hist = model.fit(x_train, y_train, epochs=65, batch_size=32, verbose=1, validation_split=0.2 , callbacks=[checkpoint,early_stopping])

#모델 저장
model.save('./mini_project/model_save/cnn_model_1.h5')
